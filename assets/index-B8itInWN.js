...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>{const{name:t,email:i,body:n}=e;return T.jsxs("div",{className:"CommentInfo",children:[T.jsxs("div",{className:"CommentInfo__title",children:[T.jsx("strong",{className:"CommentInfo__name",children:t})," by ",T.jsx("a",{className:"CommentInfo__email",href:`mailto:${i}`,children:i})]}),T.jsx("div",{className:"CommentInfo__body",children:n})]})},Lc=({commentList:e=[]})=>T.jsx("div",{className:"CommentList",children:e.map(t=>T.jsx(Pc,{comment:t},t.id))}),Tc=({user:e})=>T.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Mc=({post:e})=>{const{title:t,user:i,body:n,comments:a}=e;return T.jsxs("div",{className:"PostInfo",children:[T.jsxs("div",{className:"PostInfo__header",children:[T.jsx("h3",{className:"PostInfo__title",children:t}),T.jsxs("p",{children:[T.jsx("span",{children:" Posted by "}),T.jsx(Tc,{user:i})]})]}),T.jsx("p",{className:"PostInfo__body",children:n}),a.length?T.jsx(Lc,{commentList:a}):T.jsxs(T.Fragment,{children:[T.jsx("hr",{}),T.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]})]})},Rc=({postsList:e})=>T.jsx("div",{className:"PostList",children:e.map(t=>T.jsx(Mc,{post:t},t.id))});function Dc(e){return Nc.find(t=>t.id===e)||null}function jc(e){return zc.filter(t=>t.postId===e)}const Oc=Cc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>T.jsxs("section",{className:"App",children:[T.jsx("h1",{className:"App__title",children:"Static list of posts"}),T.jsx(Rc,{postsList:Oc})]});em(document.getElementById("root")).render(T.jsx(Fc,{}));
